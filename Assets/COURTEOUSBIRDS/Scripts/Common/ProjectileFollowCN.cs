...
public class ProjectileFollowCN : MonoBehaviour {
    ...
    public Transform farUp;             // The transform representing the upper bound of the camera's position.
    public Transform farDown;           // The transform representing the lower bound of the camera's position.
